						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<input type="checkbox" id="sHobby1" name="sHobby"
									class="" aria-required="true" required value="篮球"/>篮球
								<input type="checkbox" id="sHobby2" name="sHobby"
									class="" aria-required="true" required value="足球"/>足球
								<input type="checkbox" id="sHobby3" name="sHobby"
									class="" aria-required="true" required value="排球"/>排球
									</td>
							</tr>
						</table>
	...
	<div class="modal fade" id="modal_user_export" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					 <h4 class="modal-title" id="modal_user_del_head"> 学生管理  </h4>
				</div>
				<div class="modal-body">
							导出所选记录？
				</div>
