...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="date" name="sBirth1" class="form-control" id="txt_search_sBirth1" >
			      <input type="date" name="sBirth2" class="form-control" id="txt_search_sBirth2" >
				</div>
			  </div>
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>性别：</td>
								<td>
								<input type="radio" id="sSex1" name="sSex"
									class="" aria-required="true" required value="男"/>男
								<input type="radio" id="sSex2" name="sSex"
								...
								<td colspan="4">
									<select class="form-control" name="mId" id = "mId" aria-required="true" required>
										...
										<c:forEach items="${sList }" var="s">
										 	<option value="${s.mId }">${s.mName }</option>
										</c:forEach>
				                	</select>
								</td>
							</tr>
							<tr>
								<td>爱好：</td>
								<td>
								<input type="checked" id="sHobby1" name="sHobby"
									class="form-control" aria-required="true" required value="篮球"/>篮球
								<input type="checked" id="sHobby2" name="sHobby"
									class="form-control" aria-required="true" required value="足球"/>足球
								<input type="checked" id="sHobby3" name="sHobby"
									class="form-control" aria-required="true" required value="排球"/>排球
									</td>
							</tr>
						</table>
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            sBirth1: $("#txt_search_sBirth1").val(),
	            sBirth2: $("#txt_search_sBirth2").val(),
	...
	function initEditUser(getSelection){
		...
		var sHobby = getSelection.sHobby;
		if(sHobby.indexOf("篮球")!=-1){
		$('#sHobby1').prop("checked",true);
			
		}
		if(sHobby.indexOf("足球")!=-1){
		$('#sHobby2').prop("checked",true);
			
		}
		if(sHobby.indexOf("排球")!=-1){
		$('#sHobby3').prop("checked",true);
